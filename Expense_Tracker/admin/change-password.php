...
$query=mysqli_query($con,"select ID from tbladmin where ID='$aid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladmin set Password='$newpassword' where ID='$aid'");
...
<head>
	...
	<title>SPENDWISE || Change Password</title>
