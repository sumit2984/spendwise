...
<head>
	...
	<title>SPENDWISE || Categorywise User Expense Report</title>
...
<?php if($userdata=='all'):?>
<h5 align="center" style="color:blue">Categorywise Expense Report of All Users from  <?php echo $fdate?> to <?php echo $tdate?></h5>
<?php else: ?>
	<h5 align="center" style="color:blue">Categorywise Expense Report of <?php echo $username?> from  <?php echo $fdate?> to <?php echo $tdate?></h5>
<?php endif;?>
<hr />
